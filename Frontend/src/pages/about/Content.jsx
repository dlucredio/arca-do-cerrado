...
export const sections = [
    {
        ...
        content: ["Este site visa a divulgação para o maior número de pessoas os resultados do trabalho que realizamos na Arca do Cerrado, na Universidade Federal de São Carlos.",
